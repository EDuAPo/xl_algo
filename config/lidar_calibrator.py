...
LIDAR_CONFIGS: Dict[str, Dict[str, List[float]]] = {
    ...
    "iv_points_front_left": {
        # 相对于自车坐标系的平移 [x, y, z]
        "translation": [2.03311, 0.572856, 0.711294],  
        # 旋转角度 [Roll, Pitch, Yaw]
        "rpy_angles": [-1.52464, 0.758964, 42.7578],
        "ext_quaternion_xyzw": [-0.009975, 0.011017, 0.364412, 0.931119],
    },
    "iv_points_front_right": {
        "translation": [2.03393, -0.577244, 0.692531],
        "rpy_angles": [0.074, 0.951, -41.535],
        "ext_quaternion_xyzw": [-0.002339, 0.007989, -0.354559, 0.934996],
    },
    "iv_points_front_mid": {
        "translation": [1.946, -0.02, 1.408],
        "rpy_angles": [0.59999, -0.600001, 0.499999],
        "ext_quaternion_xyzw": [0.005213, -0.005259, 0.004336, 0.999963],
    },
    "iv_points_rear_left": {
    ...
    "iv_points_left_mid": {
        "translation": [0.597, 0.585, 1.743],
        "rpy_angles": [-30.0, 0.0, 90.0],
        "ext_quaternion_xyzw": [-0.183013, 0.183013, 0.683013, 0.683013],
    },
    "iv_points_right_mid": {
        "translation": [0.557, -0.665, 1.756],
        "rpy_angles": [30.0, 0.0, -90.0],
        "ext_quaternion_xyzw": [0.183013, 0.183013, -0.683013, 0.683013],
    }
}
