...
bool imu_msgs__msg__imu8_b__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imu_msgs.msg._imu8_b.Imu8B", full_classname_dest, 26) == 0);
  }
  imu_msgs__msg__Imu8B * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Imu8B */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("imu_msgs.msg._imu8_b");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Imu8B");
