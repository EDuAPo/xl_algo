...
bool imu_msgs__msg__imu_initial__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imu_msgs.msg._imu_initial.ImuInitial", full_classname_dest, 36) == 0);
  }
  imu_msgs__msg__ImuInitial * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ImuInitial */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("imu_msgs.msg._imu_initial");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ImuInitial");
