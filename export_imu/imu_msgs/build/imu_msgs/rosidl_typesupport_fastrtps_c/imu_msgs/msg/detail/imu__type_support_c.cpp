...
#include "imu_msgs/msg/detail/imu__rosidl_typesupport_fastrtps_c.h"
...
#include "imu_msgs/msg/detail/asensing__functions.h"  // imu_msg
...
using _Imu__ros_msg_type = imu_msgs__msg__Imu;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: imu_msg
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, imu_msgs, msg, ASENSING
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->imu_msg, cdr))
    {
      return false;
    }
  }
...
size_t get_serialized_size_imu_msgs__msg__Imu(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Imu__ros_msg_type * ros_message = static_cast<const _Imu__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_imu_msgs__msg__ASENSING(
...
static uint32_t _Imu__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_imu_msgs__msg__Imu(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_imu_msgs
size_t max_serialized_size_imu_msgs__msg__Imu(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: imu_msg
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_imu_msgs__msg__ASENSING(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = imu_msgs__msg__Imu;
    is_plain =
      (
      offsetof(DataType, imu_msg) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Imu__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_imu_msgs__msg__Imu(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, imu_msgs, msg, Imu)() {
