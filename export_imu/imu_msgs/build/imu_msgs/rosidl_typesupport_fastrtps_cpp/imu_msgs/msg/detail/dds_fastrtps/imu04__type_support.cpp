...
#include "imu_msgs/msg/detail/imu04__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const imu_msgs::msg::Imu04 & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  imu_msgs::msg::Imu04 & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = imu_msgs::msg::Imu04;
    is_plain =
      (
...
static bool _Imu04__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const imu_msgs::msg::Imu04 *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _Imu04__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<imu_msgs::msg::Imu04 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Imu04__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const imu_msgs::msg::Imu04 *>(
...
static size_t _Imu04__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Imu04(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Imu04__callbacks = {
  "imu_msgs::msg",
  "Imu04",
  _Imu04__cdr_serialize,
  _Imu04__cdr_deserialize,
  _Imu04__get_serialized_size,
  _Imu04__max_serialized_size
};

static rosidl_message_type_support_t _Imu04__handle = {
...
{
  return &imu_msgs::msg::typesupport_fastrtps_cpp::_Imu04__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, imu_msgs, msg, Imu04)() {
  return &imu_msgs::msg::typesupport_fastrtps_cpp::_Imu04__handle;
}
