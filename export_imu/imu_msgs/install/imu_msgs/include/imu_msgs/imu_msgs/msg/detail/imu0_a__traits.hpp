...
#ifndef IMU_MSGS__MSG__DETAIL__IMU0_A__TRAITS_HPP_
#define IMU_MSGS__MSG__DETAIL__IMU0_A__TRAITS_HPP_
...
inline std::string to_yaml(const Imu0A & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const imu_msgs::msg::Imu0A & msg)
{
  return imu_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<imu_msgs::msg::Imu0A>()
{
  return "imu_msgs::msg::Imu0A";
}

template<>
inline const char * name<imu_msgs::msg::Imu0A>()
{
  return "imu_msgs/msg/Imu0A";
}

template<>
struct has_fixed_size<imu_msgs::msg::Imu0A>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<imu_msgs::msg::Imu0A>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<imu_msgs::msg::Imu0A>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // IMU_MSGS__MSG__DETAIL__IMU0_A__TRAITS_HPP_
