...
class Metaclass_Imu(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from imu_msgs.msg import ASENSING
            if ASENSING.__class__._TYPE_SUPPORT is None:
                ASENSING.__class__.__import_type_support__()
...
class Imu(metaclass=Metaclass_Imu):
    ...
    _fields_and_field_types = {
        ...
        'imu_msg': 'imu_msgs/ASENSING',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['imu_msgs', 'msg'], 'ASENSING'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from imu_msgs.msg import ASENSING
        self.imu_msg = kwargs.get('imu_msg', ASENSING())
    ...
    @builtins.property
    def imu_msg(self):
        """Message field 'imu_msg'."""
        return self._imu_msg

    @imu_msg.setter
    def imu_msg(self, value):
        if __debug__:
            from imu_msgs.msg import ASENSING
            assert \
                isinstance(value, ASENSING), \
                "The 'imu_msg' field must be a sub message of type 'ASENSING'"
        self._imu_msg = value
