...
class Metaclass_Imu8B(type):
    """Metaclass of message 'Imu8B'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__imu8_b
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__imu8_b
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__imu8_b
            cls._TYPE_SUPPORT = module.type_support_msg__msg__imu8_b
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__imu8_b
...
class Imu8B(metaclass=Metaclass_Imu8B):
    """Message class 'Imu8B'."""
    ...
    def serial_number(self, value):
        if __debug__:
            ...
            assert value >= 0 and value < 256, \
                "The 'serial_number' field must be an unsigned integer in [0, 255]"
