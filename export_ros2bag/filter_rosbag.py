...
try:
    ...
    DEFAULT_SOURCE_DIRECTORY = path_config.source_directory
    DEFAULT_OUTPUT_ROOT_DIRECTORY = path_config.output_root_directory
except ImportError:
    # 如果没有配置模块，使用默认值
...
# ------------------- 默认配置 -------------------
DEFAULT_TARGET_START_TIME = "111428"  # 自动更新于 2025-12-05 18:39:18
DEFAULT_TARGET_END_TIME = "111812"    # 自动更新于 2025-12-05 18:39:18
# ----------------------------------------------
